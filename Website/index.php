              ...
              <div class="wrapper fadeInDown">
                <div id="formContent" style="background-color: rgb(36, 45, 74);">
                  ...
                  <form action="verify.php" method="POST">
                    ...
                    <input type="text" id="login" class="fadeIn second" name="email" placeholder="Email" style="background-color: rgb(49, 61, 105); border-color: rgb(49, 61, 105);">
                    <input type="password" id="password" class="fadeIn third" name="login" placeholder="password" style="background-color: rgb(49, 61, 105); border-color: rgb(49, 61, 105);">
                    <i class="bi bi-eye-slash fadeIn third" id="togglePassword" style="color: rgb(89, 77, 219);"></i>
                    <input type="submit" class="fadeIn fourth" value="Log In" style="background-color: rgb(118, 58, 138);">
